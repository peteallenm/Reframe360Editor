...
set -e
# NOTE: h264_metadata / hevc_metadata are REQUIRED by the MediaCodec ENCODER.
# It aligns the height up (1080 -> 1088) and uses the metadata bsf to signal the
# crop; without them avcodec_open2() fails with "Bitstream filter not found".
